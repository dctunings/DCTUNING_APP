...
export const ECU_DEFINITIONS: EcuDef[] = [
  ...
  //   0x037AC6  66 B u16 BE — emission cut (22424 → 32, -99.9%)
  {
    ...
    manufacturer: 'Bosch',
    family: 'EDC17',
    identStrings: ['03L906022CD', '03L906022CH', '03L906022CK', '03L906019DH', '03L906019DK', '518131', '518139', '518140', '518152', '518154'],
    fileSizeRange: [2097152, 2097152],
    vehicles: ['VW Transporter T5 2.0 TDI CR 75-103kW (03L906022CD/CH/CK + 03L906019DH/DK sw 518131/518139/518140/518152/518154, 2010-2012)'],
    checksumAlgo: 'bosch-crc32',
    checksumOffset: 0x7FFFC,
    checksumLength: 4,
    maps: [
