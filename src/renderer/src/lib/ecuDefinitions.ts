...
export const ECU_DEFINITIONS: EcuDef[] = [
  ...
  // ── Mercedes EDC16 OM646 2.2 CDI (W211/W210 C/E-class) ──────────────────
  // Confirmed via per-pair analysis of Mercedes ORI/Stage1 database:
  //   Pair #2 (sw366670) + Pair #3 (sw370739), both 1511680B EDC16 OM646
  //   EXACT anchors hit in both SWs: 0x140B99 (BE 19822→55495 +180%), 0x13F992 60B
  //   (BE 4430→10000 +126%), 0x13FE9A 60B (BE 5013→10000 +99%), 0x15C5E7 13B
  //   (BE 15668→32053 +105%), 0x15C687 13B (BE 22491→35718 +59%), 0x1364C6 24B
  //   (BE 4158→6030 +45%). ORI→Stage1 raw signatures preserved across both SWs.
  {
    id: 'mb_edc16_om646',
    ...
    maps: [
      {
        ...
        stage2: { multiplier: 1.60, clampMax: 55000 },
        stage3: { multiplier: 1.80, clampMax: 60000 },
        critical: true, showPreview: true,
      },
      {
      ...
      },
      {
        ...
        stage1: { multiplier: 1.15, clampMax: 22000 },
        stage2: { multiplier: 1.25, clampMax: 24000 },
        stage3: { multiplier: 1.35, clampMax: 26000 },
        critical: true, showPreview: true,
      },
      {
        id: 'mb_om646_torque_secondary',
        name: 'Torque Limit Secondary (low-RPM)',
        category: 'torque',
        desc: 'Mercedes OM646 secondary torque limit — low-RPM ceiling. Anchor 0x1364C6 confirmed across sister SWs (4158→6030 +45%).',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x1364C6,
        rows: 2, cols: 6, dtype: 'uint16', le: false,
        factor: 0.1, offsetVal: 0, unit: 'Nm',
        stage1: { multiplier: 1.35 },
        stage2: { multiplier: 1.55 },
        stage3: { multiplier: 1.75 },
        critical: false, showPreview: true,
      },
      {
        id: 'mb_om646_boost_duty',
        name: 'Boost Actuator Duty',
        category: 'boost',
        desc: 'Mercedes OM646 VNT actuator duty cycle. Anchor 0x15C687 confirmed (22491→35718 +59%). Raise proportionally with boost target.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x15C687,
        rows: 1, cols: 13, dtype: 'uint16', le: false,
  ...
  // ── Mercedes CRAx EDC16 W169 A/B-class 1.7/2.0 CDI (Bosch CRAx-640) ─────
  // Confirmed via per-pair analysis of Mercedes ORI/Stage1 database:
  //   Pairs #11/#12 (sw389341), #15 (sw382210), #24 (sw378289), #37 (sw383368),
  //   #39 (sw392610) — ALL 253952B or 262144B CRAx-640-C5A1/C5A2/C5A4.
  //   EXACT raw signature 6003 at fixed offset 0x011F9A across FIVE SWs.
  //   Stable anchors: 0x013EBE (32×7 fuel), 0x0015F8 (8×9 boost), 0x00183C
  //   (8×9 boost actual), 0x011C54 (loose fuel limit 30B).
  {
    ...
    vehicles: [
      'Mercedes A160 CDI W169 (2004-2012, 60kW/82PS)',
      'Mercedes A180 CDI W169 (2004-2012, 80kW/109PS)',
      'Mercedes A200 CDI W169 (2004-2012, 103kW/140PS)',
      'Mercedes B160 CDI W245 (2005-2011, 60kW/82PS)',
      'Mercedes B180 CDI W245 (2005-2011, 80kW/109PS)',
      'Mercedes B200 CDI W245 (2005-2011, 103kW/140PS)',
    ],
    checksumAlgo: 'bosch-crc32',
    checksumOffset: 0,
    checksumLength: 4,
    maps: [
      {
        ...
        rows: 12, cols: 9, dtype: 'uint16', le: false,
        factor: 0.01, offsetVal: 0, unit: 'mg/st',
        stage1: { multiplier: 1.12 },
        stage2: { multiplier: 1.22 },
        stage3: { multiplier: 1.32, clampMax: 62000 },
      ...
      {
        id: 'mb_crax_boost_target',
        name: 'Boost Pressure Target',
        category: 'boost',
        desc: 'Mercedes CRAx EDC16 boost target — anchor 0x0015F8 (8×9) confirmed across pairs #15/#24/#25/#28/#37/#39. Raw signature 1554 stable across W169/W245 A/B-class.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x0015F8,
        rows: 9, cols: 8, dtype: 'uint16', le: false,
        factor: 1, offsetVal: 0, unit: 'mbar',
        stage1: { multiplier: 1.12, clampMax: 2400 },
        stage2: { multiplier: 1.20, clampMax: 2600 },
        stage3: { multiplier: 1.28, clampMax: 2800 },
        critical: true, showPreview: true,
      },
      {
        id: 'mb_crax_boost_actual',
        name: 'Boost Actual / Feedback',
        category: 'boost',
        desc: 'Mercedes CRAx EDC16 boost feedback map — anchor 0x00183C (8×9) parallel to boost target. Stable across same pairs as boost target.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x00183C,
        rows: 9, cols: 8, dtype: 'uint16', le: false,
        factor: 1, offsetVal: 0, unit: 'mbar',
        stage1: { multiplier: 1.0 },
        stage2: { multiplier: 1.0 },
      ...
      {
        id: 'mb_crax_torque_main',
        name: 'Torque Main Map',
        category: 'torque',
        desc: 'Mercedes CRAx EDC16 torque main map — anchor 0x013EBE (32×7). Raw signature 3872 or 4232 stable across sister SWs. Pairs #11/#15/#24/#37 show Stage1 raising to ~4206-4566.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x013EBE,
        rows: 7, cols: 32, dtype: 'uint16', le: false,
        factor: 0.1, offsetVal: 0, unit: 'Nm',
        stage1: { multiplier: 1.18, clampMax: 5500 },
        stage2: { multiplier: 1.30, clampMax: 6500 },
        stage3: { multiplier: 1.45, clampMax: 7500 },
        critical: true, showPreview: true,
      },
      {
        id: 'mb_crax_fuel_limit',
        name: 'Fuel Limit (loose anchor)',
        category: 'fuel',
        desc: 'Mercedes CRAx EDC16 fuel limit region — anchor 0x011C54 30B confirmed in pairs #24 (sw378289, 4917→7010 +42%), #37 (sw383368, same 4917→7010), #38 (sw392620, 4917→6960). Stock cap limits peak fuelling — raise proportionally with main fuel quantity.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x011C54,
  ...
  // Cross-variant signatures enable one def to serve all dump formats.
  {
    ...
    maps: [
      ...
      {
        id: 'mb_om642_cr6eu5_iq_cap',
        name: 'IQ Maximum Cap (CR6EU5-642 Blue Efficiency)',
        category: 'smoke',
        desc: 'Mercedes OM642 CR6EU5-642 IQ maximum cap table — 288 bytes of 0x1388 (5000 mg/st ×0.01 = 50.00 sentinel value) with 16-byte preceding axis signature BYTE-IDENTICAL across 3 confirmed pairs: sw510865 C350 CDI 169.9kW 524KB @ 0x077018, sw501658 E350 CDI 169.9kW 2MB @ 0x1F6B08, sw510863 ML300 CDI 150kW 2MB @ 0x1F7018. Stage1 template raises cap from 34835→4135 (smoke/emission attenuation cut on 288B mirror region).',
        signatures: [
          [0x9a, 0x09, 0xcd, 0x0c, 0x66, 0x0e, 0x9a, 0x11, 0x33, 0x13, 0x66, 0x16, 0xcd, 0x1c, 0x00, 0x20],
        ],
        sigOffset: 16,
        fixedOffset: 0x077018,
        rows: 1, cols: 12, dtype: 'uint16', le: false,
        factor: 0.01, offsetVal: 0, unit: 'mg/st',
        stage1: { multiplier: 1.25 },
        stage2: { multiplier: 1.40 },
      ...
      {
        id: 'mb_om642_iq_smoke_limit',
        name: 'IQ Smoke Limit Table (V6 universal)',
        category: 'smoke',
        desc: 'Mercedes OM642 V6 3.0 CDI IQ smoke limit table. 20-byte map content signature BYTE-IDENTICAL across 38 confirmed pairs spanning E320/G320/ML280/ML320 CDI variants (458KB CLS strip, 446KB ML strip, 2MB G-class full dump). Anchor varies by SW (0x16DCA / 0x16F36 / 0x18096 / 0x180EE / 0x1A8082) but content is universal. Content: `1B BC 1A 2C 18 38 16 44 1D 4C 1C E8 1C 84 1B 58 13 88 0C E4` = physical values 71.00/67.00/62.00/57.00/75.00/74.00/73.00/70.00/50.00/33.00 mg/st.',
        signatures: [
          [0x1b, 0xbc, 0x1a, 0x2c, 0x18, 0x38, 0x16, 0x44, 0x1d, 0x4c, 0x1c, 0xe8, 0x1c, 0x84, 0x1b, 0x58, 0x13, 0x88, 0x0c, 0xe4],
        ],
        sigOffset: 0,
        fixedOffset: 0x018096,
        rows: 1, cols: 56, dtype: 'uint16', le: false,
        factor: 0.01, offsetVal: 0, unit: 'mg/st',
        stage1: { multiplier: 1.25 },
        stage2: { multiplier: 1.40 },
        stage3: { multiplier: 1.55, clampMax: 65000 },
  ...
  //   Both 2097152B CR40-640-6GA1 EDC17 ME04. EXACT raw signatures at
  //   0x0A114C (BE 34853 stock) and 0x0A1308 (BE 34561 stock) — 256-byte fuel/torque
  //   tables. Sister SWs only 1 digit apart and share identical anchor layout.
  {
    ...
    vehicles: [
      'Mercedes A160 CDI W176 (2012+, 60kW/82PS)',
      'Mercedes A180 CDI W176 (2012+, 80kW/109PS)',
      'Mercedes A200 CDI W176 (2012+, 100kW/136PS)',
      'Mercedes B160 CDI W246 (2012+)',
      'Mercedes B180 CDI W246 (2012+)',
      'Mercedes B200 CDI W246 (2012+)',
    ],
    checksumAlgo: 'bosch-crc32',
    checksumOffset: 0,
    checksumLength: 4,
    maps: [
      {
        id: 'mb_cr40_torque_table_a',
        name: 'Torque Demand Table A (34853 anchor)',
        category: 'torque',
        desc: 'Mercedes CR40 EDC17 torque demand table A — anchor 0x0A114C 256B confirmed EXACT raw 34853 across sister SWs sw512420/sw512421. Stock torque ceiling — W176 A-class 109PS stock 260 Nm, safe to 340 Nm on DSG.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x0A114C,
        rows: 16, cols: 8, dtype: 'uint16', le: false,
        factor: 0.01, offsetVal: 0, unit: 'Nm',
        stage1: { multiplier: 1.25 },
        stage2: { multiplier: 1.38 },
        stage3: { multiplier: 1.50, clampMax: 55000 },
      ...
      {
        id: 'mb_cr40_torque_table_b',
        name: 'Torque Demand Table B (34561 anchor)',
        category: 'torque',
        desc: 'Mercedes CR40 EDC17 torque demand table B — paired with table A. Anchor 0x0A1308 256B raw 34561 confirmed across sw512420/sw512421.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x0A1308,
        rows: 16, cols: 8, dtype: 'uint16', le: false,
        factor: 0.01, offsetVal: 0, unit: 'Nm',
        stage1: { multiplier: 1.25 },
        stage2: { multiplier: 1.38 },
      ...
      },
      {
        ...
        name: 'Fuel Injection Quantity',
        category: 'fuel',
        desc: 'Mercedes CR40 EDC17 fuel quantity — standard Bosch EDC17 Kf_ sig map. Increase proportionally with torque demand tables.',
        signatures: [[0x4B,0x46,0x4D,0x53,0x4E,0x57], [0x4D,0x45,0x4E,0x5A,0x4B,0x00]],
        sigOffset: 2,
        rows: 10, cols: 14, dtype: 'uint16', le: true,
        factor: 0.01, offsetVal: 0, unit: 'mg/st',
        stage1: { multiplier: 1.15 },
