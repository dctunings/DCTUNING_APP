...
export const ECU_DEFINITIONS: EcuDef[] = [
  ...
  // ── Bosch Digifant (VW Golf Mk1/2, Polo, Passat 1.3–1.8 late 80s–early 90s) ─
  {
    id: 'digifant',
    name: 'Bosch Digifant',
    manufacturer: 'Bosch',
    family: 'Digifant',
    // "DIGIFANT 1.6" or "DIGIFANT 1.8" string appears at a fixed offset in the binary
    identStrings: ['DIGIFANT', 'DIGIFANT 1.6', 'DIGIFANT 1.8', 'DIGI'],
    fileSizeRange: [16384, 65536],    // 16KB – 64KB (very old small ECU)
    vehicles: ['VW Golf Mk2 1.6 / 1.8 GTI', 'VW Polo 1.3 / 1.6', 'VW Passat 1.8', 'VW Caddy 1.6', 'VW Corrado 1.8G60', 'VW Transporter T3 1.9'],
    checksumAlgo: 'bosch-simple',
    checksumOffset: 0x7FF0,
    checksumLength: 2,
    maps: [
      {
        id: 'digifant_fuel_map',
        name: 'Fuel Injection Duration Map',
        category: 'fuel',
        desc: 'Base injection duration map (Digifant). RPM vs load (manifold pressure). Increasing this enriches fuelling for performance modifications.',
        signatures: [
          [0x44,0x49,0x47,0x49,0x46,0x41,0x4E,0x54],  // "DIGIFANT"
        ],
        sigOffset: 0x20,
        fixedOffset: 0x0200,
        rows: 8, cols: 8, dtype: 'uint8', le: true,
        factor: 0.1, offsetVal: 0, unit: 'ms',
        stage1: { multiplier: 1.08 },
        stage2: { multiplier: 1.14 },
        stage3: { multiplier: 1.20, clampMax: 255 },
        critical: true, showPreview: true,
      },
      {
        id: 'digifant_ignition',
        name: 'Ignition Timing Map',
        category: 'ignition',
        desc: 'Spark advance map. Digifant engines respond to timing optimisation — advancing 2–3° on premium fuel improves response and power.',
        signatures: [
          [0x44,0x49,0x47,0x49,0x46,0x41,0x4E,0x54],  // "DIGIFANT"
        ],
        sigOffset: 0x60,
        ...
        stage1: { addend: 2 },
        stage2: { addend: 3 },
        stage3: { addend: 4, clampMax: 60 },
        critical: true, showPreview: true,
      },
      {
        id: 'digifant_lambda_corr',
        name: 'Lambda Correction Map',
        category: 'fuel',
        desc: 'Lambda correction / mixture adaptation map. Adjusting this fine-tunes air/fuel ratio across the load range.',
        signatures: [],
        sigOffset: 0,
        fixedOffset: 0x0300,
        rows: 4, cols: 8, dtype: 'uint8', le: true,
        factor: 0.1, offsetVal: -12.8, unit: '%',
        stage1: { multiplier: 1.0 },
        stage2: { multiplier: 1.0 },
        stage3: { multiplier: 1.0 },
        critical: false, showPreview: false,
  ...
  // ── Bosch ME7 (classic VAG petrol) ───────────────────────────────────────
  {
    ...
    manufacturer: 'Bosch',
    family: 'ME7',
    identStrings: ['ME7', 'ME7.5', 'ME7.1', 'ME7.3', '0261204', '0261206', '0261207', 'MEVBOGK', 'TR HS V0'],
