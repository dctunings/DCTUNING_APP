...
const DEVICES: Device[] = [
  {
    ...
    ecuFamilies: [
      'Bosch ME7 / ME7.5 (VAG petrol)',
      'Bosch ME9 / MED9 (VAG FSI)',
      'Bosch MED17 / MED17.7 (VAG petrol)',
      'Bosch MG1 (VAG post-2018)',
      'Bosch EDC15 (VAG diesel pre-2006)',
      'Bosch EDC16 (VAG/Merc diesel)',
      'Bosch EDC17 / EDC17CP (VAG diesel)',
    ...
    recommended: [
      'All makes general workshop',
      'VAG specialist',
      'Best all-round investment',
    ],
  },

  {
    ...
    ecuFamilies: [
      'Bosch ME7 / ME7.5 (VAG bench)',
      'Bosch MED17 / MED17.7 (VAG bench/BDM)',
      'Bosch MG1 (VAG bench — Tricore BSL)',
      'Bosch EDC16 / EDC17 (VAG bench)',
...

  {
    ...
    ecuFamilies: [
      'Bosch ME7 / MED17 / MG1 (VAG)',
      'Bosch EDC16 / EDC17 (VAG)',
...

  {
    ...
    ecuFamilies: [
      'Bosch ME7 / ME7.5 (VAG petrol)',
      'Bosch MED17 / MEDC17 (VAG)',
      'Bosch MG1 (VAG post-2018)',
      'Bosch EDC15 / EDC16 / EDC17 (VAG/Merc)',
      'Continental SIMOS 10/18 (VAG)',
      'Siemens SIM2K / PCR2.1 (VAG)',
      'ZF 8HP / DSG (TCU)',
    ],
...

  {
    ...
    ecuFamilies: [
      'Bosch MED17 / MEDC17 / MG1 (VAG)',
      'Bosch EDC16 / EDC17 (VAG/Merc)',
      'Continental SIMOS 10/18 (VAG)',
...

  {
    ...
    ecuFamilies: [
      'Bosch MEDC17 / MED17 (VAG)',
      'Bosch EDC17 (VAG diesel)',
      'Continental SIMOS 18 (VAG)',
    ],
    vehicles: [
      'VAG',
    ],
...

  {
    ...
    ecuFamilies: [
      'All OBD2-compliant ECUs',
    ],
    vehicles: [
      'All makes (1996+ USA, 2001+ EU diesel, 2003+ EU petrol)',
    ],
...

  {
    ...
    ecuFamilies: [
      'All OEM ECUs via OEM software',
    ],
    vehicles: [
      'All makes with OEM software subscription',
    ],
...

  {
    ...
    ecuFamilies: [
      'Bosch EDC15 (pre-2008)',
      'Bosch EDC16 (pre-2010)',
      'Siemens PPD1.x (older VAG)',
      'Marelli IAW older',
    ],
    vehicles: [
      'VAG (pre-2012)',
...

  {
    ...
    caps: { flashRead: false, flashWrite: false, clone: false, checksum: false, dtc: true, liveData: true },
    ecuFamilies: [
      'OBD2 diagnostics only',
    ],
    vehicles: [
      'All OBD2 vehicles (diagnostics only)',
    ],
...

  {
    ...
    ecuFamilies: [
      'Bosch ME7 / ME7.5 (VAG petrol — OBD)',
      'Bosch ME9 / MED9 (VAG FSI — OBD)',
      'Bosch MED17 (VAG — OBD & Boot)',
      'Bosch EDC15 (VAG diesel pre-2006 — OBD)',
      'Bosch EDC16 (VAG/Merc — OBD)',
      'Bosch EDC17 (VAG — OBD & Boot, limited)',
    ...
    recommended: [
      'Already owned — works fine for reads',
      'Upgrade to KESS3 for new installs',
    ],
  },

  {
    ...
    caps: { flashRead: true, flashWrite: true, clone: true, eeprom: true, checksum: 'auto', dtc: true, liveData: false, immo: true },
    ecuFamilies: [
      'Bosch MED17 / MEDC17 (VAG — OBD & bench)',
      'Bosch MG1 (VAG — Tricore BSL)',
      'Bosch EDC16 / EDC17 (VAG — OBD & bench)',
      'Continental SIMOS 10/18 (VAG — OBD & bench)',
      'Siemens PCR2.1 (VAG TDI — OBD)',
      'ZF 8HP / DSG DQ200/250 (TCU)',
      'Bosch ME7 / ME9 (VAG petrol)',
    ],
    vehicles: [
      'VAG',
    ],
    ...
    recommended: [
      'Budget VAG bench work',
      'TCU flashing (ZF 8HP / DSG)',
      'MG1 Tricore BSL',
    ],
  },

  {
    ...
    ecuFamilies: [
      'Bosch EDC16 — select VAG (OBD, limited protocols)',
    ],
    vehicles: [],
...

  {
    ...
    ecuFamilies: [
      ...
      'Bosch MED17 / MEDC17 (VAG)',
      'Bosch MG1 (VAG — Tricore BSL)',
      'Continental SIMOS 8–18 (VAG)',
      'Siemens PCR2.1 (VAG TDI)',
      'ZF 8HP TCU (VAG)',
      'Getrag/DSG DCT250 TCU',
    ],
    vehicles: [
      'VAG',
    ],
...

  {
    ...
    caps: { flashRead: true, flashWrite: true, clone: false, checksum: 'unreliable', dtc: true },
    ecuFamilies: [
      'Bosch EDC15 (pre-2006)',
      'Bosch EDC16 (pre-2010, limited)',
      'Bosch EDC17 (select OBD protocols, very limited)',
      'Siemens PPD1.x (older VAG)',
    ],
    vehicles: [
      'VAG (pre-2010 primarily)',
    ],
...

  {
    ...
    recommended: [
      'Budget Tactrix alternative',
      'Diagnostics on any make',
    ],
  },

  {
    ...
    recommended: [
      'Best budget J2534 hardware',
      'CAN FD / post-2020 vehicles',
    ],
  },

  {
    ...
    caps: { flashRead: true, flashWrite: true, clone: true, eeprom: true, checksum: 'auto', dtc: true, liveData: true, immo: true },
    ecuFamilies: [
      'Bosch EDC16 / ME9 — VAG (OBD, bench, boot)',
      'Bosch MEDC17 — VAG (OBD, bench, boot)',
      'Bosch MD1 / MG1 — VAG MQB/MLB (OBD, bench)',
    ...
    recommended: [
      'VAG OBD + bench tuning',
      'Multi-make diagnostics',
      'TCU tuning (DQ200/DQ380/ZF)',
    ],
  },
