...
export default function J2534PassThru({ connected, setConnected, activeVehicle }: Props) {
  ...
  // Scanmatik Web Serial Lab removed in v3.16.0 — superseded by the local
  // Bridge service which speaks the J2534 DLL directly. The protocol-capture
  // approach is no longer needed because the bridge gives full hardware
  // access without reverse-engineering Scanmatik's wire protocol.
